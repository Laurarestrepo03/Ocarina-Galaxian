...
class PlayScene(Scene):
    ...
    def do_update(self, delta_time: float, screen):
        ...
        if self.execute_game:
            ...
            system_enemy_movement(self.ecs_world, delta_time, screen)
            system_explosion_state(self.ecs_world)
            system_bullet_limit(self.ecs_world, screen)
            system_player_limit(self.ecs_world, screen)
            system_enemy_bullet_spawn(self.ecs_world, self.enemy_bullet_cfg, self.enemies_cfg, delta_time)
